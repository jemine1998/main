...
public class CommandTestUtil {
    ...
    public static final String VALID_PHONE_AMY = "1";
    public static final String VALID_PHONE_BOB = "2";
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_LEVEL + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_LEVEL + VALID_PHONE_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_LEVEL + "911a"; // 'a' not allowed in phones
