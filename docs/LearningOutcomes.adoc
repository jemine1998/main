...
Note how the <<DeveloperGuide#architecture, Developer Guide>> describes the high-phone design using an _Architecture Diagrams_ and high-phone sequence diagrams.
...
* Write a unit test for a high-phone method somewhere in the code base (or a new method you wrote).
