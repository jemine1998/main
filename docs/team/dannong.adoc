...
* *Code contributed*: [https://nuscs2113-ay1819s2.github.io/dashboard-beta/#search=&sort=displayName&since=2019-02-10&until=2019-04-14&timeframe=day&reverse=false&repoSort=true[Functional code]][https://github.com/cs2113-ay1819s2-m11-3/main/blob/master/src/main/java/seedu/address/logic/commands/DeadlineCommand.java [Test Code]]
...
** Highlights: -
** Credits: https://docs.oracle.com/javase/8/javafx/api/javafx/scene/control/Button.html[Button]
* *Minor enhancement*: Changed the background of GUI display to black for the text to stand out. Add mnemonicParsing for the buttons. (Pull request https://github.com/cs2113-ay1819s2-m11-3/main/pull/86[#86])
