...
** Testing:
*** Updated the existing test for the new application (Pull request: https://github.com/cs2113-ay1819s2-m11-3/main/pull/74[#74], )
*** Created test for the new commands I have created ()
** Documentation:
